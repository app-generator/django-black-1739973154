...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-black-1739973154) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-black-1739973154.git
$ cd django-black-1739973154
```
